...
def simular_espectro(t_actual, sel):
    ...
    if fondo_continuo:
        ...
        fondo_ambiental *= tiempo_medicion * 1.8  # escala ajustable
    ...
    if fondo_continuo:
        ...
        ruido_electronico *= tiempo_medicion * 0.0  # Escalado bajo
...
if iniciar:
    ...
    for t_min in range(0, t_max + 1, paso_tiempo):
        espectro56Mn = simular_espectro(t_min + t_max, seleccion1[1])
        espectro28Al = simular_espectro(t_min, seleccion1[0])
